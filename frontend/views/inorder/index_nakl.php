...
$this->title = 'Возвратные накладные';
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <?= $this->render('/inorder/_form_mod_nakl',['model' => $ord]); ?>
        </div>
...
//            'income_date',
            ...
            'buttons' => [
                'upd'=>function($url,$model){
                    $url=Yii::$app->getUrlManager()->createAbsoluteUrl(['/inorder/updatemod-nakl','id'=>$model->id]);
                ...
                'spec' => function ($url, $model) { //download-alt
                    $customurl=Yii::$app->getUrlManager()->createUrl(['/inorder-spec/index-nakl','id'=>$model->id]); //$model->id для AR
